...
- quien [creo](abrir) la [obs](tipoIncidencia) [123456789](codigoIncidencia)
...
class ActionAvion(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if re.match(r'[0-9]{3}$', codigoAvion):
            ...
            cur.execute(
                "SELECT count(*) from lm_fil_operaciones_incidencias where avion ='"
                + codigoAvion
                + "';"
            )
            rows = cur.fetchall()
            if str(rows[0]) != '(0,)':
                ...
                if int(rowAvion) < 5:
                    ...
                    cur.execute(
                        "SELECT * from lm_fil_operaciones_incidencias where avion ='"
                        + codigoAvion
                        + "'ORDER BY orden ASC;"
                    )
                    rows = cur.fetchall()
        ...
        if avion != None and estacion == None and tipoIncidencia == None:
            ...
            if (
                ...
                cur.execute(
                    "SELECT count(*) from lm_fil_operaciones_incidencias;"
                )
                rows = cur.fetchall()
                if str(rows[0]) != '(0,)':
                    row = str(rows[0])
                ...
                cur.execute(
                    "SELECT * from lm_fil_operaciones_incidencias;"
                )
                rows = cur.fetchall()
                estacion = ""
                if rows != []:
                ...
                cur.execute(
                    "SELECT count(*) from lm_fil_operaciones_incidencias where estacion = '"
                    + codigoEstacion
                    + "';"
                )
                rows = cur.fetchall()
                ...
                cur.execute(
                    "SELECT * from lm_fil_operaciones_incidencias where estacion = '"
                    + codigoEstacion
                    + "';"
                )
                rows = cur.fetchall()
            ...
            if (
                ...
                cur.execute(
                    "SELECT count(*) from lm_fil_operaciones_incidencias where tipo_incidencia = '"
                    + tipoIncidencia
                    + "';"
                )
                rows = cur.fetchall()
                ...
                cur.execute(
                    "SELECT * from lm_fil_operaciones_incidencias where tipo_incidencia = '"
                    + tipoIncidencia
                    + "';"
                )
                rows = cur.fetchall()
            ...
            cur.execute("SELECT count(*) from lm_fil_operaciones_incidencias where estacion = '"
                    + codigoEstacion
                    + "' and tipo_incidencia = '"
                    + tipoIncidencia
                    + "' and avion = '"
            ...
            cur.execute("SELECT * from lm_fil_operaciones_incidencias where estacion = '"
                    + codigoEstacion
                    + "' and tipo_incidencia = '"
                    + tipoIncidencia
                    + "' and avion = '"
            ...
            if partnumber != "":
                try:
                    if partnumber[0] != "":
                        cur.execute(
                            "SELECT count(*) from lm_fil_operaciones_incidencias where partnumber = '"
                            + partnumberSlot
                            + "';"
                        )
                        rows = cur.fetchall()
                        ...
                        cur.execute(
                            "SELECT * from lm_fil_operaciones_incidencias where partnumber = '"
                            + partnumberSlot
                            + "';"
                        )
                        rows = cur.fetchall()
        ...
        if re.match(r'[0-9]{1}[5]{1}$', codigoEstacion):
            ...
            if tipoIncidencia == None:
                if (
                    ...
                    cur.execute(
                        "SELECT id_unico, partnumber, orden, operacion, avion, estacion, id_gnt, descripcion_gnt, tipo_incidencia, descripcion_incidencia from lm_fil_operaciones_incidencias where estacion = '"
                        + codigoEstacion
                        + "';"
                    )
                    rows = cur.fetchall()
            ...
            if rows != []:
                if tipoIncidencia != None:
                    ...
                    for row in rows:
                        ...
                        cur.execute(
                            "SELECT id_unico, partnumber, orden, operacion, avion, estacion, version_demat, tipo_incidencia, descripcion_incidencia from lm_fil_operaciones_incidencias where estacion = '"
                            + rowEstacion
                            + "'and tipo_incidencia = '"
                            + tipoIncidencia
                            + "';"
                    ...
                    for row in rows:
                        ...
                        rowGNT = rowGNT.split(" ")
                        cur.execute(
                            "SELECT id_unico, partnumber, orden, operacion, avion, estacion, id_gnt, descripcion_gnt, tipo_incidencia, descripcion_incidencia from lm_fil_operaciones_incidencias where id_gnt = '"
                            + rowGNT[2]
                            + "';"
                        )
