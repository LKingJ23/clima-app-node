...
- ¿Quién [abrió](abrir) la última [HNC](tipoIncidencia)?
...
- quien [creo](abrir) la [hnc](tipoIncidencia) [123456789](codigoIncidencia)
- quien [abrio](abrir) la [123456789](codigoIncidencia)
- quien [abrio](abrir) la [444444444](codigoIncidencia)
...
## intent:intent_incidencias_avion
- ¿Cuantas ha tenido el [avion](avion) [160](codigoAvion) en la [estacion](estaciones:estaciones) [15](codigoEstacion)?
- [Incidencias](incidencia:incidencia) [avion](avion) [186](codigoAvion)
- ¿Cuantas [incidencias](incidencia:incidencia) tiene el [avión](avion:avion) [182](codigoAvion)?
- detallame las [HNC](tipoIncidencia) que ha tenido el [aviones](avion:avion) [184](codigoAvion)
- [HNC's](tipoIncidencia)  [avion](avion) [160](codigoAvion) + [estacion](estaciones:estaciones) [15](codigoEstacion)
- Dime el numero de [HNCs](tipoIncidencia) del [avión](avion:avion) [187](codigoAvion)
- Cuántas [observaciones](tipoIncidencia) ha habido en el [aviones](avion:avion) [178](codigoAvion)?
- Numero total de [incidencias](incidencia:incidencia) en [estacion](estaciones:estaciones) [45](codigoEstacion) [aviones](avion:avion) [178](codigoAvion).
- ¿Cuál fue la [HNC](tipoIncidencia) del [avión](avion:avion) [184](codigoAvion) en la [estación](estaciones:estaciones) [45](codigoEstacion)?
- ¿Cuántos [observaciones](tipoIncidencia) ha tenido el [avión](avion:avion) [182](codigoAvion)?
- Dime cuántas [no conformidades](tipoIncidencia) tiene el [avión](avion:avion) [177](codigoAvion) en la [estación](estaciones:estaciones) [35](codigoEstacion)
- [observaciones](tipoIncidencia) [avion](avion) [178](codigoAvion)
- Cuántas [incidencias](incidencia:incidencia) ha habido en el [avión](avion:avion) [183](codigoAvion)?
- ¿En el [avión](avion:avion) [177](codigoAvion) cuantas [incidencias](incidencia:incidencia) se han abierto?
- ¿Numero de [problema](incidencia:incidencia) del [avión](avion:avion) [186](codigoAvion)?
- relaciona las [HNCs](tipoIncidencia) del [avion](avion) [171](codigoAvion)
- Dime el número [HNCs](tipoIncidencia) que tiene/tuvo el [aviones](avion:avion) [160](codigoAvion) en la [estación](estaciones:estaciones) [15](codigoEstacion)
- [Observaciones](tipoIncidencia) [avion](avion) [173](codigoAvion) + [estacion](estaciones:estaciones) [45](codigoEstacion)
- Listame las [HNCs](tipoIncidencia) del [avión](avion:avion) [172](codigoAvion)
- [hnc](tipoIncidencia) [avion](avion) [160](codigoAvion)
- Dime el número de [no conformidades](tipoIncidencia) que tiene/tuvo el [aviones](avion:avion) [177](codigoAvion) en la [estación](estaciones:estaciones) [15](codigoEstacion)
- En total cuantas [HNCs](tipoIncidencia) tiene el [avión](avion:avion) [173](codigoAvion) teniendo en cuenta sólo las [estaciones](estaciones) de [FAL](codigoEstacion)
- ¿Cuántas [desviaciones](incidencia:incidencia) ha tenido el P/N [95-21001-0001GBR145149N01](partNumber)?
- ¿cuantas [HNC´s](tipoIncidencia) tiene la [st](estaciones:estaciones) [65](codigoEstacion)?
- [hnc](tipoIncidencia) [st](estaciones:estaciones) [45](codigoEstacion)
- ¿Se ha producido alguna [dificultad](incidencia:incidencia) con el P/N [95-INSP-CIERRE-CONSOLA-CENTRAL](partNumber)?
- ¿Cuál es la última [HNC](tipoIncidencia) del P/N [95-00168-0001EM01ERC00152](partNumber)?
- Cuantas [desviaciones](incidencia:incidencia) hemos tenido?
- [dificultad](incidencia) [st](estaciones:estaciones) [fal](codigoEstacion)
- dime todas las [incidencias](incidencia:incidencia)
- Cuántas [HNC](tipoIncidencia) se han abierto en el GNT [avionico](avion:avion) de la [estación](estaciones:estaciones) [45](codigoEstacion)?
...
- dime las [incidencias](incidencia:incidencia) del partnumber [95-21001-0001GBR145149N01](partNumber)
- cuantas [incidencias](incidencia:incidencia) tiene la [estacion](estaciones) [55](codigoEstacion)
...
- Quién [cerró](cerrar) la [OB](tipoIncidencia) [2589633695](codigoIncidencia)?
...
- dime las [hnc](tipoIncidencias) [cerradas](cierre)
...
- [Estado](estado:estado) [incidencia](tipoIncidencia) [58567](codigoIncidencia)
- ¿en que [punto](estado:estado) esta la [ob](tipoIncidencia) [4553355996](codigoIncidencia)?
...
- [Estado](estado:estado) de [observacion](tipoIncidencia) [4965822222](codigoIncidencia)
...
- [Estado](estado:estado) de [operacion](operacion) [2222](codigoOperacion)
...
- ¿Cómo se [encuentra](estado:estado) la [incidencia](tipoIncidencia) [9999](codigoIncidencia)?
...
- Como se [encuentra](estado:estado) la [observación](tipoIncidencia) [4789996477](codigoIncidencia)?
- Está bloqueada la [observación](tipoIncidencia) [4966697799](codigoIncidencia)?
...
- [obs](tipoIncidencia) de la [7654321](codigoIncidencia)
...
- ¿que personas han intervenido en la [incidencia](tipoIncidencia) [4888888852](codigoIncidencia)?
...
- Usuario de ultima disposicion de [HNC](tipoIncidencia) [221111116](codigoIncidencia)
...
- cuantas [incidencias](incidencia:incidencia) tiene el [gnt](tipoGNT) [FUSELAJE INTERIOR](descripcionGNT) [ESTACIÓN](estaciones) [55](codigoEstacion)?
- cuantas [obs](tipoIncidencia) tiene el [gnt](tipoGNT) [SUBCONTRAT](descripcionGNT) [ESTACION](estaciones) [25](codigoEstacion)?
- [incidencias](incidencia:incidencia) [gnt](tipoGNT) [AVIONICO](descripcionGNT) [ESTACION](estaciones) [45](codigoEstacion)
...
- cuantas [incidencias](incidencia:incidencia) tiene el [gnt](tipoGNT) [avionico](descripcionGNT) [estacion](estaciones) [45](codigoEstacion)?
- cuantas [demat](tipoIncidencia) tiene el [gnt](tipoGNT) [subcontrat](descripcionGNT) [estacion](estaciones) [25](codigoEstacion)?
- [incidencias](incidencia:incidencia) [gnt](tipoGNT) [electromecanico](descripcionGNT) [estación](estaciones) [35](codigoEstacion)
...
## story_operacion
* intent_incidencias_operacion{"tipoIncidencia": "obs", "operacion": "operación", "codigoOperacion": "7654321"}
...
## story_operacion2
* intent_incidencias_operacion{"tipoIncidencia": "obs", "codigoOperacion": "7777777"}
 - slot{"tipoIncidencia": "obs"}
...
## story_operacion3
* intent_incidencias_operacion{"incidencia": "incidencias", "operacion": "operacion", "codigoOperacion": "1234"}
 - slot{"incidencia": "incidencias"}
 - slot{"operacion": "operacion"}
 - slot{"codigoOperacion": "1234"}
 - action_operacion
 - utter_ayuda_algo_mas
* no_negacion
 - utter_greeting_final
...
## story_operacion4
* intent_incidencias_operacion{"incidencia": "incidencias", "operacion": "operacion", "codigoOperacion": "8754125"}
 - slot{"incidencia": "incidencias"}
 - slot{"operacion": "operacion"}
...
## story_operacion5
* intent_incidencias_operacion{"incidencia": "incidencias", "codigoOperacion": "7654321"}
 - slot{"incidencia": "incidencias"}
 - slot{"codigoOperacion": "7654321"}
 - action_operacion
 - utter_ayuda_algo_mas
...
## story_operacion6
* intent_incidencias_operacion{"tipoIncidencia": "demat", "operacion": "operación", "codigoOperacion": "8885554"}
...
## story_avion_check
* intent_incidencias_avion{"avion": "avion", "codigoAvion": "186"}
 - slot{"avion": "avion"}
...
* intent_incidencias_apertura{"abrir": "abrio","tipoIncidencia": "incidencia", "codigoIncidencia": "123456"}
 - slot{"abrir": "abrio"}
...
* intent_incidencias_apertura{"codigoOperacion": "7654321", "cerrar": "cerro"}
 - slot{"codigoOperacion": "7654321"}
 - slot{"cerrar": "cerro"}
 - action_cierre_operacion
 - utter_ayuda_algo_mas
...
## story_incidencia_responsable6
* operaciones_responsable{"responsable": "encargado", "operacion": "op", "codigoOperacion": "7654321"}
 - slot{"responsable": "encargado"}
 - slot{"operacion": "op"}
 - slot{"codigoOperacion": "7654321"}
 - action_responsable_operacion
 - utter_ayuda_algo_mas
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if tipoIncidencia == None:
            ...
            if str(rows[0]) != '(0,)':
                ...
                row = "".join(row)
                rowOBS = row.replace(",", "").replace("(", "").replace(")", "")
                dispatcher.utter_message("<b>Existen " + rowOBS + " HNC en la orden " + codigoOrden + "</b>")
            ...
            if str(rows[0]) != '(0,)':
                ...
                row = "".join(row)
                rowDEMAT = row.replace(",", "").replace("(", "").replace(")", "")
                dispatcher.utter_message("<b>Existen " + rowDEMAT + " HNC en la orden " + codigoOrden + "</b>")
...
class ActionAperturaOperacion(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        cur.execute(
            "SELECT inicio_real, operario_asignado from estado_ordenes where orden = '"
            + codigoOrden
            + "';"
        )
        rows = cur.fetchall()
...
class ActionCierreOperacion(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        cur.execute(
            "SELECT fin_real_notificado, operario_asignado from estado_ordenes where orden = '"
            + codigoOrden
            + "';"
        )
        rows = cur.fetchall()
...
class ActionResponsableOperacion(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        cur.execute(
            "SELECT inicio_real, fin_real_notificado, operario_asignado from estado_ordenes where orden = '"
            + codigoOrden
            + "';"
        )
        rows = cur.fetchall()
...
class ActionEstado(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if codigoIncidencia != None:
            ...
            if tipoIncidencia == "demat":
            ...
            elif (int(codigoIncidencia) >= 1000000000 and int(codigoIncidencia) <= 3000000000):
                if tipoIncidencia == "hnc":
                    cur.execute(
                ...
                dispatcher.utter_message("La " + tipoIncidencia + " " + codigoIncidencia + " no existe.")
        
        if descripcionEstado != None:
            cur.execute(
                "SELECT count(*) from zqm_ob_2018 where estado = '"
                + descripcionEstado
                + "';"
            )
            rows = cur.fetchall()
            ...
            cur.execute(
                "SELECT count(*) from zqm_hnc_2018 where status_a = '"
                + descripcionEstado
                + "';"
            )
            rows = cur.fetchall()
            ...
            cur.execute(
                "SELECT count(*) from demat where status = '"
                + descripcionEstado
                + "';"
            )
            rows = cur.fetchall()
...
class ActionEstadoOperacion(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        cur.execute("SELECT estado, inicio_real, fin_real_notificado, operario_asignado from estado_ordenes where orden = '" + codigoOrden + "';")
        rows = cur.fetchall()
        if rows != []:
            index = 0
            for row in rows:
...
class ActionGNT(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if str(rows[0]) != '(0,)':
            ...
            dispatcher.utter_message('Existen ' + rowNumber + ' incidencias con el gnt ' + descripcionGNT + ' en la estacion ' + codigoEstacion)
            return []

        if tipoGNT != None and descripcionGNT != None:
            cur.execute(
                "SELECT id_estacion_gnt from lm_gnt where descripcion_gnt like '"
                + descripcionGNT
                + "';"
            )
            rows = cur.fetchall()
                ...
                if tipoIncidencia != None:
                    ...
                    for row in rows:
                        ...
                        if rowsGNT != []:
                            ...
                            dispatcher.utter_message("<b>Existen " + rowInci + " incidencias en la estación " + rowEstacion + "</b>")
                            '''
                            cur.execute(
                                "SELECT id_unico, partnumber, orden, operacion, avion, estacion, version_demat, tipo_incidencia, descripcion_incidencia from lm_fil_opercaciones_incidencias where estacion = '"
                                + rowEstacion
...
class ActionOrden(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if "nombre" in aOrden:
            cur.execute(
                "SELECT nombres from estado_ordenes where orden = '" + codigoOrden + "';"
            )
            rows = cur.fetchall()
            if rows != []:
                index = 0
